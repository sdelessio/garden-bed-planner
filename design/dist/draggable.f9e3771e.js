...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"draggable.js":[function(require,module,exports) {
var jq = $.noConflict();
  ...
  function createGrid(size) {
    ...
    for (i = 0; i <= ratioW; i++) {
      ...
      $('<div />').css({
        ...
        'width': 1,
        'height': height
      }).addClass('gridlines gridlines-vertical').appendTo(sel);
    }
    ...
    for (i = 0; i <= ratioH; i++) {
      ...
      $('<div />').css({
        ...
        'width': width,
        'height': 1
      }).addClass('gridlines gridlines-horizontal').appendTo(sel);
    }

    $('.gridlines').show();
  }

  createGrid(12); // Change height of plot with height input

  jq("#height-input").on('input', function () {
    var value = jq(this).val(); // Each inch is equal to 12 pixels
...
},{}]},{},["../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","draggable.js"], null)
//# sourceMappingURL=/draggable.f9e3771e.js.map